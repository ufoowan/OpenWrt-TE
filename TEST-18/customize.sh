...
# Device exclusive
svn export --force https://github.com/lc-sub/OpenWrt-TE/trunk/TEST-18/dts32 target/linux/ramips/dts/mt7621_d-team_pbr-m1.dts
...
svn export --force https://github.com/lc-sub/OpenWrt-TE/trunk/TEST-18/mk32 target/linux/ramips/image/mt7621.mk
