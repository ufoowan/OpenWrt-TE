...
svn export --force https://github.com/lc-sub/OpenWrt-TE/trunk/TEST-3/net target/linux/ramips/mt7621/base-files/etc/board.d/02_network
...
#wget -nv https://github.com/lc-sub/OpenWrt-TE/raw/main/TEST-3/net -O target/linux/ramips/mt7621/base-files/etc/board.d/02_network
